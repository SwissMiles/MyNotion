...
export function FocusView() {
  ...
  return (
    <div className="page-wrap">
      ...
      {perCourse.length > 0 && (
        <>
          <h2 className="section-title"><span className="section-title-label">📚 This week by course</span></h2>
          <div className="card">
              ...
              return (
                <div key={courseId || "general"} className="focus-bar-row">
                  <span className="focus-bar-label">
                    <ColorDot color={course?.color ?? "var(--text-3)"} size="sm" />
      ...
      {recent.length > 0 && (
        <>
          <h2 className="section-title"><span className="section-title-label">🕘 Recent sessions</span></h2>
